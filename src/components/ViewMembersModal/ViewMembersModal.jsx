  ...
  <Modal className="viewMembers" isOpen={this.props.isOpen} toggle={this.props.toggle} keyboard={this.props.keyboard} >
    ...
    <ModalBody>
      <ListGroup className="border-0 rounded-0 member-list">
        ...
        <ListGroupItem className="m-0 py-2 px-1 border-left-0 border-right-0 rounded-0 admin-user">
          <CardImg className="mr-2 d-inline-block img" src={"/images/placeholder.png"}/>
