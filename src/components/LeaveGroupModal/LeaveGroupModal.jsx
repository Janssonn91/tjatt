<Fragment >
  ...
  <Modal isOpen={this.props.isOpen} toggle={this.props.toggle} className="leave-group-modal">
    ...
    <ModalBody>
      {this.props.channelStore.currentGroupMembers.length === 1 ? <h6>You are about to leave the group "        {this.props.channelStore.channelName}" as the last member. This will disband the group, and the chat history will be deleted.</h6>
      : 
